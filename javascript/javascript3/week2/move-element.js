// Creating new scope
{
    ...
    setInterval(() => {
        setTargetFulfilled(redBox, targets[0], {x: targets[0].offsetLeft , y: targets[0].offsetTop});
        setTargetFulfilled(blueBox, targets[1], {x: targets[1].offsetLeft, y: targets[1].offsetTop});
        setTargetFulfilled(greenBox, targets[2], {x: targets[2].offsetLeft, y: targets[2].offsetTop});
